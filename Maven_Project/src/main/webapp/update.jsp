	...
	<div class="container">
		<div class="row mt-3">
			<div class="col-lg-6 m-auto">
				...
				<input type="hidden" value="<%=em.getEmployeeId() %>" name="id">
					<div class="form-group mb-3">
						<label>Employee Name</label> <input type="text" name="ename"
							id="ename" class="form-control" value="<%=em.getEmpName()%>">
					</div>
					...
					<div class="form-group mb-3">
						<label>Age</label> <input type="number" name="age" id="age"
							class="form-control" value="<%=em.getAge()%>">
					</div>
					<div class="form-group mb-3">
						<label>Salary</label> <input type="number" name="salary"
							id="salary" class="form-control" value="<%=em.getSalary()%>">
					</div>
					<label>Joining Date</label>
					<div id="datepicker" class="input-group date form-group"
						data-date-format="dd-MM-yyyy">
						<input class="form-control" type="text" value="<%=em.getJoiningDate()%> %>" name="joiningdate" readonly /> <span
							class="input-group-addon"> <i
							class="glyphicon glyphicon-calendar"></i>
						</span>
					</div>

					<button type="submit" class="btn btn-primary btn-lg mb-3" id="sbtn">Update</button>
